    ...
    public class RuntimeMeshImportExport : ModuleRules
    {
        ...
        public RuntimeMeshImportExport(ReadOnlyTargetRules Target) : base(Target)
        {
            ...
            if ((Target.Platform == UnrealTargetPlatform.Win64))
            {
                ...
                string FileNameNoExt = "assimp-vc142-mt" + (Target.Configuration == UnrealTargetConfiguration.Shipping ? "" : "d");
                //string FileNameNoExt = "assimp-vc142-mt";
            ...
            if (Target.Platform == UnrealTargetPlatform.Android)
            {
                ...
                string dllName = "libassimp.so";
                string dllFile = Path.Combine(ThirdPartyPath, "assimp/bin/Android", architecture, dllName);
                PrivateDependencyModuleNames.AddRange(new string[] { "Launch" });
                PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "UMG", "AndroidPermission" });
               
                AdditionalPropertiesForReceipt.Add("AndroidPlugin", Path.Combine(ThirdPartyPath, "assimp/bin/Android", "upl.xml"));
                PublicAdditionalLibraries.Add(dllFile);
            }
